...
import com.playground.jetpackplayground.ui.auth.ForgotPasswordFragment.WebAppInterface.OnWebInteractionCallback
import com.playground.jetpackplayground.util.Constants
...
class ForgotPasswordFragment : BaseAuthFragment() {
    ...
    val webInteractionCallback : OnWebInteractionCallback = object : OnWebInteractionCallback {
        override fun onSuccess(email: String) {
            Log.d(TAG, "onSuccess: a reset will be sent to that $email")
    ...
    override fun onAttach(context: Context) {
        ...
        try {
            ...
            Log.e(TAG, "onAttach: $context must implement DataStateChangeListenere")
        }
    }
}